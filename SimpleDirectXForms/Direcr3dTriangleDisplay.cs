...
namespace SimpleDirectXForms
{
    class Direcr3dTriangleDisplay
    {
        ...
        public Direcr3dTriangleDisplay(RenderForm form, Device device)
        {
            _renderForm = form;
            _device = device;
        }
        ...
        {
            _vertexBuffer = new VertexBuffer(_device, 3 * 20, Usage.WriteOnly, VertexFormat.None, Pool.Managed);
